    ...
    try {
      if (Platform.OS == 'ios') {
        ...
        const granted = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.CAMERA, {
          ...
          message: 'Aplikasi Semargres 2022 membutuhkan izin Kamera',
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.mainContainer}>
          ...
          >
            ...
            <View style={{ backgroundColor: colors.black3, width: '100%', height: 1 }}></View>
        ...
        >
          <QRCodeScanner
            ...
            bottomContent={<TouchableOpacity style={styles.buttonTouchable}></TouchableOpacity>}
          />
